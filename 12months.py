...
renderView1.Set(
    ...
    CameraPosition=[-20.0, 87.52444617484726, 0.0],
...
streamTracerWithCustomSource1 = StreamTracerWithCustomSource(registrationName='StreamTracerWithCustomSource1', Input=t01_field_timeseries_month_XMLpvd,
...
# show data from t01_field_timeseries_month_XMLpvd
t01_field_timeseries_month_XMLpvdDisplay = Show(t01_field_timeseries_month_XMLpvd, renderView1, 'StructuredGridRepresentation')

# trace defaults for the display properties.
t01_field_timeseries_month_XMLpvdDisplay.Set(
    Representation='Outline',
    ColorArrayName=[None, ''],
)

# init the 'Piecewise Function' selected for 'ScaleTransferFunction'
t01_field_timeseries_month_XMLpvdDisplay.ScaleTransferFunction.Points = [-17647.650390625, 0.0, 0.5, 0.0, 32957.73046875, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
t01_field_timeseries_month_XMLpvdDisplay.OpacityTransferFunction.Points = [-17647.650390625, 0.0, 0.5, 0.0, 32957.73046875, 1.0, 0.5, 0.0]
...
b_totalLUT.Set(
    RGBPoints=[
        ...
        2.592746812970877, 0.243, 0.46035, 0.81,
        11.704153012159313, 0.356814, 0.745025, 0.954368,
        57.23760915105537, 0.6882, 0.93, 0.91791,
        128.16774297932744, 0.899496, 0.944646, 0.768657,
        365.48761646615594, 0.957108, 0.833819, 0.508916,
        1482.8957137798739, 0.927521, 0.621439, 0.315357,
        7961.617336054349, 0.8, 0.352, 0.16,
        48631.31464540145, 0.59, 0.0767, 0.119475,
    ],
    UseLogScale=1,
...
# init the 'Piecewise Function' selected for 'ScaleTransferFunction'
streamTracerWithCustomSource1Display.ScaleTransferFunction.Points = [-35090.2582400414, 0.0, 0.5, 0.0, 29658.767115054223, 1.0, 0.5, 0.0]

# init the 'Piecewise Function' selected for 'OpacityTransferFunction'
streamTracerWithCustomSource1Display.OpacityTransferFunction.Points = [-35090.2582400414, 0.0, 0.5, 0.0, 29658.767115054223, 1.0, 0.5, 0.0]
...
b_totalPWF.Set(
    Points=[0.33778585794345295, 0.0, 0.5, 0.0, 48631.31464540143, 1.0, 0.5, 0.0],
