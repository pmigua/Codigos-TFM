...
t01_SM_seeds_timeseries_month_XMLpvd = PVDReader(registrationName='T01_SM_seeds_timeseries_month_XML.pvd', FileName=os.path.join(SCRIPT_DIR, 'T01_timeseries_month', 'T01_SM_seeds_timeseries_month_XML.pvd'))
t01_SM_seeds_timeseries_month_XMLpvd.PointArrays = ['hemisphere']

# create a new 'PVD Reader'
t01_field_timeseries_month_XMLpvd = PVDReader(registrationName='T01_field_timeseries_month_XML.pvd', FileName=os.path.join(SCRIPT_DIR, 'T01_timeseries_month', 'T01_field_timeseries_month_XML.pvd'))
