...
field_timesteps = read_timesteps_from_pvd("T01_field_timeseries.pvd")
seed_timesteps = read_timesteps_from_pvd("T01_SM_seeds_timeseries.pvd")
...
write_pvd("T01_field_timeseries_XML.pvd", field_xml_entries)
write_pvd("T01_SM_seeds_timeseries_XML.pvd", seed_xml_entries)

print("\nListo.")
print(f"Campos convertidos: {len(field_xml_entries)}")
print(f"Semillas convertidas: {len(seed_xml_entries)}")
print("Abre en ParaView:")
print("  T01_field_timeseries_XML.pvd")
print("  T01_SM_seeds_timeseries_XML.pvd")
